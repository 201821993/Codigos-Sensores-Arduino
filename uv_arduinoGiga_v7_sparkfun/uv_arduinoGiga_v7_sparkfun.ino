 ...
 EN = 3.3V
 3.3V = A1
 vin = vin (parece que funciona mejor sin el sensor)
...
/*
 * Seguimos la misma conexion que aquí  https://cdn.sparkfun.com/assets/learn_tutorials/2/0/6/ML8511_UV_Hookup.png?_gl=1*cg14tm*_ga*MTkzOTQyOTk0Ny4xNjkzMjUwMTc2*_ga_T369JS7J9N*MTcwNjMwNTM5NS4yOC4xLjE3MDYzMDY0MjkuNjAuMC4w 
  la diferencia es que conectamos vin con vin

https://learn.sparkfun.com/tutorials/ml8511-uv-sensor-hookup-guide?_gl=1*hw3pge*_ga*MTkzOTQyOTk0Ny4xNjkzMjUwMTc2*_ga_T369JS7J9N*MTcwNjg5OTg4NS4yOS4xLjE3MDY4OTk4OTguNDcuMC4w&_ga=2.92290653.1530484145.1706899886-1939429947.1693250176
...
void loop()
{
  ...
  float outputVoltage = refLevel * uvLevel;
